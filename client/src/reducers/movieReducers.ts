import {
    ...
    MovieTopActionTypes,
    MovieTopState,
    MovieCreateReviewAction,
    MovieCreateReviewActionTypes,
...
const initialMovieCreateReviewState: MovieCreateReviewState = {
    loading: false
};

export const movieCreateReviewReducer = (
    state: MovieCreateReviewState = initialMovieCreateReviewState,
    action: MovieCreateReviewAction
) => {
    switch (action.type) {
        case MovieCreateReviewActionTypes.MOVIE_CREATE_REVIEW_REQUEST:
            return { loading: true };
        case MovieCreateReviewActionTypes.MOVIE_CREATE_REVIEW_SUCCESS:
            return {
                loading: initialMovieCreateReviewState.loading,
                success: true
            };
        case MovieCreateReviewActionTypes.MOVIE_CREATE_REVIEW_FAILURE:
            return {
                error: action.payload
            };
        case MovieCreateReviewActionTypes.MOVIE_CREATE_REVIEW_RESET:
            return {};
        default:
            return state;
    }
